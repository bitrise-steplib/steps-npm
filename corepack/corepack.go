...
// Enable runs `corepack enable npm` to install the npm shim.
// The bare `corepack enable` (no args) skips npm intentionally per corepack's design,
// since npm ships with Node.js. Passing "npm" explicitly installs the shim.
